...
const StatDisplay = ({ title, value, subtitle }) => (
  <div className="text-center p-4">
    <div className="text-white text-base font-semibold opacity-80 mb-1">
      {title}
    </div>
    ...
    <div className="mx-auto min-h-[80vh]">
      ...
      <div className="text-center py-16 bg-white relative overflow-hidden shadow-md">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center space-x-4 mb-16">
            ...
            <a
              href="#"
              className="btn btn-outline border-gray-300 hover:border-gray-500 hover:bg-white text-gray-700 text-lg"
            >
          ...
          <div className="flex justify-center -mb-20">
            ...
            <img
              ...
              className="w-1/2 max-w-sm h-[300px] w-[600px] rounded-3xl shadow-2xl"
            />
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto p-4 pt-12 text-center">
        ...
        <div className="text-center mt-10">
          <Link
            to="/products"
            className="btn btn-lg bg-violet-600 hover:bg-violet-700 text-white shadow-lg"
          >
            Show All
          </Link>
        </div>
